...
export default function SearchProductCard({
  ...
  return (
    <Link onClick={() => setOpenSearch(false)} href={`/products/${code}`} className="w-full border hover:border-zinc-400 dark:hover:border-zinc-700 border-border rounded-xl flex h-28 sm:h-32">
