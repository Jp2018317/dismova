...
export default function ProductsAmount({ stock }: Props) {
  ...
  return (
    ...
    <div className="flex">
      <button disabled={(ammount <= 1)} onClick={() => setAmmount(ammount - 1)} type="button" className="w-8 lg:w-10 h-8 lg:h-8 rounded-l-lg bg-primary flex justify-center items-center disabled:bg-primary/80">
